...
export EVAL_ID="${EVAL_ID:-act224_001}"
export POLICY_PATH="${POLICY_PATH:-${repo_root}/outputs/train/cobot_magic_cube_into_drawer_act_success_only_224_v1/checkpoints/100000/pretrained_model}"
...
export POLICY_NUM_INFERENCE_STEPS="${POLICY_NUM_INFERENCE_STEPS:-}"
