...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument("command_topic", default_value="/cobot_magic/command/joint_left"),
        DeclareLaunchArgument("manual_control_topic", default_value="/cobot_magic/leader/manual_control_left"),
        DeclareLaunchArgument("end_topic", default_value="/cobot_magic/puppet/end_left"),
    ]
