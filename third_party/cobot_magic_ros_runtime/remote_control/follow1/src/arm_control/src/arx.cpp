...
////topic ////////////////////////////////////////////////////
    ...
    node.param<std::string>("command_topic", command_topic, "/cobot_magic/command/joint_right");
    node.param<std::string>("state_topic", state_topic, "/cobot_magic/puppet/joint_right");
    ...
    {   
        ...
        if(msg->position.size() >= 7)
        {
            for(int8_t i = 0; i < 7; ++i )
            {
                ...
                if (i == 6) ARX_ARM.ros_control_pos_t[i] *= 4.5;    // 夹爪传动比映射
            }
        }
