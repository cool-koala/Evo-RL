...
void arx_arm::update_real(command cmd)
{
    ...
    else
    {
        ...
        else if(control_mode == 2 || control_mode == 3) // 关节控制模式
        {
...
void arx_arm::gripper_control()
{
    ...
    else
    {
        ...
        if(play.is_playing)
        {
            ...
            CAN_Handlej.Send_moto_Cmd2(8, 12, 1,   target_pos[6], 0,  0 );usleep(200); 
        ...
        }else
        {
            ...
            CAN_Handlej.Send_moto_Cmd2(8, 12, 1,   gripper_pos[0], 0,  0 );usleep(200); 
        }        
