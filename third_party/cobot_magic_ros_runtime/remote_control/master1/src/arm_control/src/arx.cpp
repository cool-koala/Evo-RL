...
int main(int argc, char **argv)
{
        ...
        &publish_manual_control_status](bool enabled)
    {
        ...
        if (enabled)
        {
            ...
            ROS_INFO("Cobot Magic leader right switched to manual-control mode.");
        }
        else
        {
...
///////topic///////////////////////////////////////
                        ...
                        {   
                            ...
                            // if (i == 6) msg_joint01.position[i] *= 12;    // 将内部单位(0-54)转换为ROS单位(0-4.5)
                        }
...
///////////////////////////////////////////////////
    ...
    ROS_WARN("Cobot Magic leader right stopping motors.");
    CAN_Handlej.arx_2();
    usleep(100000);
    _exit(0);
    return 0;
